 ...
 *	IP 주소
 	...
 	- DNS(Domain Name System)를 통해 해당 도메인의 IP 주소를 알아낼 수 있다 [cmd창 -> tracert '도메인주소']
...
public class InetAddressTest {
	...
	public static void main(String[] args) {
		try {
			...
			System.out.println("호스트 이름 : " + ip.getHostName());		// getHostName() => google.com
			System.out.println("호스트의 IP 주소 : " + ip.getHostAddress());
			System.out.println();
