...
//		b.method1();		// count, sum, average, max, min, findFirst
		b.method2();		// reduce
	}
	...
	public void method1() {
		...
		System.out.println("요소들의 합계 : " + sum);
		...
		// get : 저장되어 있는 값을 얻기 위해 사용하는 메서드
		
		System.out.println("요소들의 평균 : " + average.getAsDouble());	// OptionalDouble를 double 타입으로
		...
		System.out.println("요소들의 최대 값 : " + max.getAsInt());		// OptionalInt를 int 타입으로
		System.out.println("요소들의 최대 값 : " + maxResult);
		...
		System.out.println("요소들의 첫번째 값 : " + first.getAsInt());
	}
