...
public class Application {
	 ...
	 *	- 클래스는 필드(Field), 메서드(Method), 생성자(Constructor)가 정의가 되어야 됨
	...
	public static void main(String[] args) {
		...
		// 객체 생성 = 메모리에 올린다 = 객체의 구성요소(Field, Method)가 다 올라간다 (Heap 영역에)
		Tv tv = new Tv();
		...
		tv.power();		// TV 켜기 !	[TV 클래스에서 전원 켜는 함수 호출하여 실행]
...
/*
//	한 파일에 여러 클래스가 올 수는 있지만, 파일 이름과 같은 클래스는 public이 있어야 함.
class Tv{
