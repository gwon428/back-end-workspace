...
INSERT INTO tb_publisher(pub_name, phone) VALUES ('천그루숲', '010-8784-0784');
...
INSERT INTO tb_member (member_id, member_pwd, member_name, gender, address, phone) VALUES ('user01', 'pass01', '홍길동', 'M', '서울시 강서구', '010-1111-2222');
INSERT INTO tb_member (member_id, member_pwd, member_name, gender, address, phone) VALUES ('user02', 'pass02', '김말똥', 'M', '서울시 강남구', '010-3333-4444');
INSERT INTO tb_member (member_id, member_pwd, member_name, gender, address, phone) VALUES ('user03', 'pass03', '강길순', 'F', '경기도 광주시', '010-4444-5555');
...
REATE TABLE tb_rent (
    ...
    -- FOREIGN KEY (member_no) REFERENCES tb_member(member_no) ON DELETE SET NULL,
    -- FOREIGN KEY (rent_book_no) REFERENCES tb_rent2(book_no) ON DELETE SET NULL
    );

-- ALTER로 FOREIGN KEY만 관리
ALTER TABLE tb_book ADD CONSTRAINT pub_no_fk FOREIGN KEY (pub_no) REFERENCES tb_publisher(pub_no) ON DELETE CASCADE;
ALTER TABLE tb_rent ADD CONSTRAINT member_no_fk FOREIGN KEY (member_no) REFERENCES tb_member(member_no) ON DELETE SET NULL;
ALTER TABLE tb_rent ADD CONSTRAINT bk_no_fk FOREIGN KEY (bk_no) REFERENCES tb_book(bk_no);
...
SELECT bk_title 도서명, pub_name 출판사명, rent_date 대여일, ADDDATE(rent_date, 7) '반납 예정일'
FROM tb_rent
